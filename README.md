...
- [ ] **Upload de arquivos** (Anexos aos projetos)
...
- [ ] **Banco real** (PostgreSQL/MongoDB)
- [ ] **API robusta** (Node.js/Fastify)
...
- **CSS Purge** - Classes não utilizadas removidas
...
Este projeto foi desenvolvido como demonstração técnica e está disponível sob a licença MIT.

---

**Desenvolvido com ❤️ usando Vue 3 + Nuxt 3 + Pinia**
